...
var BlockViewComponent = /** @class */ (function () {
    function BlockViewComponent() {
        ...
        setTimeout(function () {
            console.log('from block-view component => ', _this.block);
        }, 2000);
    }
    BlockViewComponent.prototype.handleClick = function () {
...
var BlockchainViewsComponent = /** @class */ (function () {
    function BlockchainViewsComponent(blockchainService) {
    ...
    BlockchainViewsComponent.prototype.ngOnInit = function () { };
    BlockchainViewsComponent.prototype.showData = function (block) {
        this.selectedBlock = block;
    };
    BlockchainViewsComponent.ctorParameters = function () { return [
    ...
    return BlockchainViewsComponent;
}());
...
var CreateDataComponent = /** @class */ (function () {
    function CreateDataComponent(blockchainService, dataService) {
        this.blockchainService = blockchainService;
        this.dataService = dataService;
        this.walletKey = blockchainService.walletKeys[0];
        this.newDt = dataService.dataInstance;
    }
    CreateDataComponent.prototype.ngOnInit = function () { };
    CreateDataComponent.prototype.createData = function () {
    ...
    CreateDataComponent.ctorParameters = function () { return [
        { type: _services_blockchain_service__WEBPACK_IMPORTED_MODULE_2__["BlockchainService"] },
...
var DataTableComponent = /** @class */ (function () {
    function DataTableComponent(blockchainService) {
        this.blockchainService = blockchainService;
        this.metadata = [];
    }
    DataTableComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () {
            console.log('metadata from data-table component => ', _this.metadata);
        }, 2000);
    };
...
var PendingDataComponent = /** @class */ (function () {
    function PendingDataComponent(blockchainService) {
        this.blockchainService = blockchainService;
        this.pendingData = [];
        this.pendingData = blockchainService.getPendingData();
    }
    PendingDataComponent.prototype.ngOnInit = function () { };
    PendingDataComponent.prototype.minePendingData = function () {
        this.blockchainService.minePendingData();
    };
    PendingDataComponent.ctorParameters = function () { return [
        { type: _services_blockchain_service__WEBPACK_IMPORTED_MODULE_2__["BlockchainService"] }
    ]; };
...
var BlockchainService = /** @class */ (function () {
    ...
    BlockchainService.prototype.addData = function (dt) {
        this.blockchainInstance.addData(dt);
    };
    BlockchainService.prototype.getPendingData = function () {
        return this.blockchainInstance.pendingData;
    };
    BlockchainService.prototype.minePendingData = function () {
